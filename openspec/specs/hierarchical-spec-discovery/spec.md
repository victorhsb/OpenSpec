# Hierarchical Spec Discovery Specification

## Purpose
Define how OpenSpec discovers specifications within the `openspec/specs/` directory tree, supporting both flat and hierarchical (nested) spec layouts.
